...
const Services = () => {
  return (
    <section id='services' className='bg-[#201f31] py-20'>
      <div className='container'>
        <div className='mb-12 text-center'>
          <h2 className='mb-2 text-3xl font-bold md:text-4xl'>Our Services</h2>
          <p className='mx-auto max-w-2xl text-[#aaa]'>
        ...
        <div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3'>
          {ServicesData.map((service, index) => (
            <Card key={index} className='border-white/10 bg-gray-700/20 transition-transform hover:-translate-y-1'>
